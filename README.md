...
module "red5pro_single" {
  ...
  path_to_red5pro_build     = "./red5pro-server-0.0.0.b00-release.zip"                       # Absolute path or relative path to Red5 Pro server ZIP file
  ...
  single_droplet_size                        = "c-4"                                         # Droplet size for Red5 Pro server in Digital Ocean
...
module "red5pro_cluster" {
  ...
  path_to_red5pro_build                    = "./red5pro-server-0.0.0.000-release.zip"        # Absolute path or relative path to Red5 Pro server ZIP file
  ...
  dedicated_terraform_service_host_create = true                                                         # true- Create a dedicate terraform service droplet   false - install locally on stream manager
